    ...
    <body>
        <nav epub:type="toc" id="toc">
            ...
            {% for chapter in chapters %}
                <li id="chapter_{{ chapter.idx }}"><a href="{{ chapter.file_name }}">{{ chapter.title }}</a></li>
            {% endfor %}
            </ol>
        </nav>
    </body>
...
PACKAGE_OPF_TEMPLATE="""<?xml version="1.0" encoding="UTF-8"?>
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
   ...
   <manifest>
      <item href="xhtml/chapter_nav.xhtml" id="nav" media-type="application/xhtml+xml" properties="nav"/>
      {% for chapter in chapters %}
   ...
   <spine>
      ...
      {% for chapter in chapters %}
      <itemref idref="chapter_{{ chapter.idx }}"/>
      {% endfor %}
   </spine>
</package>
"""